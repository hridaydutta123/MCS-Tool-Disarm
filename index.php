        ...
        <nav class="navbar navbar-inverse navbar-fixed-top navbar-custom" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <div style="background: #fff;">
                    <a class="navbar-brand" href="index.php"><i class="fa fa-cog fa-spin"></i> MCS Dashboard</a>
                </div>
            </div>
            <!-- Top Menu Items -->
            
            <!-- Sidebar Menu Items - These collapse to the responsive navigation menu on small screens -->
            <div class="collapse navbar-collapse navbar-ex1-collapse" style="border-bottom:1px dashed #ffffff;border-top:1px dashed #ffffff;" id="scrollDiv">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="javascript:;" data-toggle="collapse" data-target="#fileViewer"><i class="fa fa-fw fa-desktop"></i> File Viewer<i class="fa fa-fw fa-caret-down"></i></a>
                        <ul id="fileViewer" class="collapse">
                            <li>
                                <a href="viewAudio.php">Audio</a>
                            </li>
                            <li>
                                <a href="viewVideo.php">Video</a>
                            </li>
                            <li>
                                <a href="viewImage.php">Image</a>
                            </li>
                            <li>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-red">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-map-marker"></i> Map of Overall data collected</h3>
                            </div>
                            <div class="panel-body">
							<?php include_once 'map/plot.php';?>
							<div class="text-right">
                                    <a href="analysis/mAnalysis.php">View Details <i class="fa fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                url: 'process.php',
                    ...
                    success: function(data)
                    {
                        ...
                        if(nextVal > firstVal)
                        {
                            ...
                            $.notify({
                                // options
                                message: 'You have new Files in sync folder. Press Sync!!' 
                            },{
                                // settings
                                type: 'warning'
                            });
