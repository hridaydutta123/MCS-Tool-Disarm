...
<body>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-yellow">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="glyphicon glyphicon-refresh"></i> Audio Result </h3>
                            </div>
                            <div class="panel-body">
                                   ...
                                   <?php
                                        ...
                                        $cdquery="SELECT filename FROM file_details where type = 'AUD'";
                                        $cdresult=mysql_query($cdquery) or die ("Query to get data from firsttable failed: ".mysql_error());

                                        $j=0;
                                        while ($cdrow=mysql_fetch_array($cdresult)) {
                                            $cdTitle = $cdrow["filename"];
                                        //echo '<source src="sync/'.$cdTitle.'" type="video/mp4">';
                                        echo '<audio class="audio" width="320" height="240" poster="images/video-camera-icon.png" controls preload="none">';
                                        echo '<source src="sync/'.$cdTitle.'" type="audio/mp3">';
                                        echo $cdTitle;
                                        echo '</audio>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
                                            //echo '<a href="sync/'.$cdTitle.'" rel="prettyPhoto[pp_gal]" title="asd"><img class="example-image" src="sync/'.$cdTitle.'"/></a><br />' ;  
                                         }
    ...
    <script type="text/javascript" charset="utf-8">
            $(document).ready(function(){
                $('.audio').click(function(){this.paused?this.play():this.pause();});
