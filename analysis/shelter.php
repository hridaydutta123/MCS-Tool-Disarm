                    ...
                    <div class="col-lg-6">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-bar-chart-o"></i> Shelter Available</h3>
                            </div>
                            <div class="panel-body">
								<?php include_once 'bar/shelterTemporaryBar.php';?>	
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                ...
                <!-- /.row -->
				 ...
				 <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-table"></i> Shelter Available</h3>
                            </div>
                            <div class="panel-body">
