            ...
            <div class="container-fluid">
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-bar-chart-o"></i> Line chart of text data relevance</h3>
                            </div>
                            <div class="panel-body">
								<?php include_once 'alchemyapi/alchemyapiLine.php';?>
								<div class="text-right">
                                    <a href="alchemyapi.php">View Details <i class="fa fa-arrow-circle-right"></i></a>
                                </div>								
                            </div>
                        </div>
                    </div>
                ...
                <!-- /.row -->
				 ...
				 <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-bar-chart-o"></i> Tree map of text data</h3>
                            </div>
                            <div class="panel-body">
								<?php include_once 'alchemyapi/alchemyapiTreemap.php';?>
								<div class="text-right">
                                    <a href="alchemyapi.php">View Details <i class="fa fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
				...
				<div class="row">
                    <div class="col-lg-4">
                        <div class="panel panel-green">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-long-arrow-right"></i> Food Type Requirement</h3>
                            </div>
                            <div class="panel-body">
							<?php include_once 'bar/foodRequirementBar.php';?>
                                <div class="text-right">
                                    <a href="food.php">View Details <i class="fa fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="panel panel-yellow">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-long-arrow-right"></i> Medicine Requirement</h3>
                            </div>
                            <div class="panel-body">
							<?php include_once 'bar/medRequirementBar.php';?>
                                <div class="text-right">
                                    <a href="medicine.php">View Details <i class="fa fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
					<div class="col-lg-4">
                        <div class="panel panel-red">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-long-arrow-right"></i>Affected Districts</h3>
                            </div>
                            <div class="panel-body">
							<?php include_once 'pie/affectedDistPie.php';?>
                                <div class="text-right">
                                    <a href="affectedArea.php">View Details <i class="fa fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
				...
				<div class="row">
                    <div class="col-lg-6">
                        <div class="panel panel-green">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-long-arrow-right"></i> Victim affected</h3>
                            </div>
                            <div class="panel-body">
							<?php include_once 'pie/victimPie.php';?>
                                <div class="text-right">
                                    <a href="victim.php">View Details <i class="fa fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="panel panel-yellow">
                            ...
                            <div class="panel-body">
							<?php include_once 'bar/victimBar.php';?>
                                <div class="text-right">
                                    <a href="victim.php">View Details <i class="fa fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
				...
				<div class="col-lg-4">
                        <div class="panel panel-yellow">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-long-arrow-right"></i> Shelter Available</h3>
                            </div>
                            <div class="panel-body">
							<?php include_once 'pie/shelterTemporaryPie.php';?>
                                <div class="text-right">
                                    <a href="shelter.php">View Details <i class="fa fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="panel panel-green">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-long-arrow-right"></i> Type of data in database</h3>
                            </div>
                            <div class="panel-body">
							<?php include_once 'pie/typePie.php';?>
                                <div class="text-right">
                    ...
                    <div class="col-lg-4">
                        <div class="panel panel-yellow">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-long-arrow-right"></i> Different TTL</h3>
                            </div>
                            <div class="panel-body">
							<?php include_once 'line/ttlLine.php';?>
                                <div class="text-right">
                                    <a href="#">View Details <i class="fa fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
				...
				<div class="row">
                    <div class="col-lg-4">
                        <div class="panel panel-green">
                            ...
                            <div class="panel-body">
							<?php include_once 'bar/typeBar.php';?>
                                <div class="text-right">
                                    <a href="#">View Details <i class="fa fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-8">
                        <div class="panel panel-yellow">
                            ...
                            <div class="panel-body">
							<?php include_once 'bar/ttlBar.php';?>
                                <div class="text-right">
                                    <a href="#">View Details <i class="fa fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-red">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-long-arrow-right"></i> Word Cloud of Text data</h3>
                            </div>
                            <div class="panel-body">
							<?php include_once 'wordCloud/wordCloud.php';?>
                                <div class="text-right">
                                    <a href="#">View Details <i class="fa fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
