            ...
            <div class="container-fluid">
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-red">
							...
							<div class="text-right">
                                    <a href="map/plot.php">View Details <i class="fa fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
				...
				<div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-map-marker"></i> Map of Unstructured Data</h3>
                            </div>
                            <div class="panel-body">
								<?php include_once '../map/plotAlchemy.php';?>	
                            </div>
                        </div>
                    </div>
                </div>
                <!-- /.row -->
				 <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-map-marker"></i> Food Requirement Map</h3>
                            </div>
                            <div class="panel-body">
								<?php include_once '../map/plotFood.php';?>	
                            </div>
                        </div>
                    </div>
                </div>
				...
				<div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-map-marker"></i> Medicine Requirement Map</h3>
                            </div>
                            <div class="panel-body">
								<?php include_once '../map/plotMedicine.php';?>	
                            </div>
                        </div>
                    </div>
                </div>
				...
				<div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-map-marker"></i> Victim Affected Map</h3>
                            </div>
                            <div class="panel-body">
								<?php include_once '../map/plotVictim.php';?>	
                            </div>
                        </div>
                    </div>
                </div>
