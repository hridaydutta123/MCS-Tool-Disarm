                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-bar-chart-o"></i> Analysis results of text data</h3>
                            </div>
                            <div class="panel-body">
								<?php include_once 'alchemyapi/alchemyapiTable.php';?>
				...
				<div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="panel panel-yellow">
                            ...
                            <div class="panel-body">
							<?php include_once 'tables/medRequirementTable.php';?>
                                <div class="text-right">
					...
					<div class="col-lg-4">
                        <div class="panel panel-red">
                            ...
                            <div class="panel-body">
							<?php include_once 'tables/victimTable.php';?>
                                <div class="text-right">
				...
				<div class="row">
                    <div class="col-lg-4">
                        <div class="panel panel-green">
                            ...
                            <div class="panel-body">
							<?php include_once 'tables/shelterTemporaryTable.php';?>
                                <div class="text-right">
                    ...
                    <div class="col-lg-4">
                        <div class="panel panel-green">
                            ...
                            <div class="panel-body">
							<?php include_once 'tables/typeTable.php';?>
                                <div class="text-right">
                    ...
                    <div class="col-lg-4">
                        <div class="panel panel-yellow">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-long-arrow-right"></i> Different Time to Leave</h3>
                            </div>
                            <div class="panel-body">
							<?php include_once 'tables/ttlTable.php';?>
                                <div class="text-right">
                                    <a href="#">View Details <i class="fa fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
