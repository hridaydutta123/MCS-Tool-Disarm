<?php
//This Script is not in active page for now
...
<html>
  <head>
	...
	var bar_options = {
	  ...
	  var chart = new google.visualization.ColumnChart(document.getElementById('foodRequirementBar_div'));
  ...
  <body>
	...
	<div id="foodRequirementBar_div"></div>
  </body>
</html>