                ...
                <!-- /.row -->
				 <div class="row">
                    <div class="col-lg-6">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-bar-chart-o"></i> Medicine Requirement</h3>
                            </div>
                            <div class="panel-body">
                    ...
                    <div class="col-lg-6">
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
								<?php include_once 'pie/medRequirementPie.php';?>	
                            </div>
                        </div>
                    </div>
                </div>
                <!-- /.row -->
				 ...
				 <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-table"></i> Medicine Requirement</h3>
                            </div>
                            <div class="panel-body">
