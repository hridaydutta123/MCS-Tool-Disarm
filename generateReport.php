...
//echo '<script type="text/javascript">alert("' .$data->results[0]->formatted_address . '")</script>';
echo '<script type="text/javascript">alert("' .$pieces[2]. '")</script>';*/
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="map/plot.php"><i class="glyphicon glyphicon-map-marker"></i>Visualize on map</a>
                    </li>
                    <li>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-red">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-file-text-o"></i> Select to Generate Report</h3>
                            </div>

						    <form action="generate.php" method="post">
                            <div class="panel-body checkbox" style="margin-left:2%;" >
							<div class="panel panel-primary" id="divrepr">
									<div class="panel-heading">Select type to generate report</div>
									<div class="panel-body"  style="margin-left:2%"><input type="checkbox" name="Food" value="Food" />Food</div>
									<div class="panel-body"  style="margin-left:2%"><input type="checkbox" name="Medicine" value="Medicine" />Medicine</div>
									<div class="panel-body" style="margin-left:2%"><input type="checkbox" name="Victim" value="Victim" />Victim</div>
									<div class="panel-body" style="margin-left:2%"><input type="checkbox" name="Affected" value="Affected" />Affected Area</div>
									<div class="panel-body" style="margin-left:2%"><input type="checkbox" name="Shelter" value="Shelter" />Shelter</div>
								<input type="submit" name="formSubmit"  style="margin-bottom:2%; margin-left:2%;" value="Submit" class="btn btn-primary"/>
							
							</div>
							</form>
							<form action="generatestate.php" method="post">
							<div class="panel panel-primary">							
						      <div class="panel-heading"><input type="checkbox"  style="margin-left:0.2%;margin-bottom:2%;" id="locationcb" name="location" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Generate Report with Location
			
						      <input type="submit" name="formSubmit" style="float:right;margin-top:-0.8%;" value="Submit" class="btn btn-success"/></div>
						    </div>
						    </form>
    ...
    <script type="text/javascript">
    	$('#locationcb').on('change', function() { 
		    ...
		    if (!this.checked) {
		    	$('#divrepr :checkbox:lt(5)').prop('disabled', false);
		    	 $("#divrepr").children().prop('disabled',false);
		    }
		    else
		    {
		    	  $('#divrepr :checkbox:lt(5)').prop('disabled', true);
		    	 $("#divrepr").children().prop('disabled',true);
		    }
		});
    </script>
