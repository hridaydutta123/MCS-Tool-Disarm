                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-green">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-long-arrow-right"></i> Text data</h3>
                            </div>
                            <div class="panel-body  form-group">
							<form>
								<bott><select style="font-size : 11.5px; height: 30px;" class="form-control" name="users" onchange="showUser(this.value)">
								...
								<?php
									...
									$cdquery="SELECT filename FROM file_details where type = 'SMS'";
