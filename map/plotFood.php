...
function initialize(elementId, stateAbbr) {
    ...
    $.ajax(
        {
            url : 'http://localhost/disarm/map/fetchFood.php',
...
function createMap(elementId, xml) {
    ...
    markerCluster = new MarkerClusterer(mapFood, markers);
    for (i = 0; i < latlngs.length; i++) {
        bounds.extend(latlngs[i]);
    }
    mapFood.fitBounds(bounds);
    return mapFood;
}
...
<body>
	<div id="mapFood" style="width: 100%; height:400px;"></div>
</body>
</html>