...
function initialize(elementId, stateAbbr) {
    ...
    $.ajax(
        {
            url : 'http://localhost/disarm/map/fetchVictim.php',
...
function createMap(elementId, xml) {
    ...
    function createMarker(latlng, icon) {
        ...
        google.maps.event.addListener(
            ...
            function () {
                ...
                infoWindow.open(mapVictim, marker);
            }
        );
        markers.push(marker);
    }
    ...
    markerCluster = new MarkerClusterer(mapVictim, markers);
    for (i = 0; i < latlngs.length; i++) {
        bounds.extend(latlngs[i]);
    }
    mapVictim.fitBounds(bounds);
    return mapVictim;
}
...
<body>
	<div id="mapVictim" style="width: 100%; height:400px;"></div>
</body>
</html>