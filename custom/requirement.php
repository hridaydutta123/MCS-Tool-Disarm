                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-fw fa-question"></i> Requirement
                            </li>
                        </ol>
                    </div>
                </div>
				...
				<div class="row">
                    <div class="col-lg-4">
                        <div class="panel panel-green">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-long-arrow-right"></i> <?php $requirementTitle = ucfirst($requirementType); echo $requirementTitle;?>  Requirement</h3>
                            </div>
                            <div class="panel-body">
							<?php 
							if ($requirementType == 'food')
							{
								include_once '../analysis/bar/foodRequirementBar.php';
							}
							elseif($requirementType == 'medicine')
							{
								include_once '../analysis/bar/medRequirementBar.php';
							}
							else
							{
								include_once '../analysis/bar/shelterTemporaryBar.php';
							}
							?>
                    ...
                    <div class="col-lg-4">
                        <div class="panel panel-yellow">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-long-arrow-right"></i> <?php $requirementTitle = ucfirst($requirementType); echo $requirementTitle;?>  Details</h3>
                            </div>
                            <div class="panel-body">
							<?php 
							if ($requirementType == 'food')
							{
								include_once '../analysis/pie/foodRequirementPie.php';
							}
							elseif($requirementType == 'medicine')
							{
								include_once '../analysis/pie/medRequirementPie.php';
							}
							else
							{
								include_once '../analysis/pie/shelterTemporaryPie.php';
							}
							?>
                                <div class="text-right">
                                    <a href="#">View Details <i class="fa fa-arrow-circle-right"></i></a>
					...
					<div class="col-lg-4">
                        <div class="panel panel-red">
							...
							if ($requirementType == 'food')
							{
								include_once '../analysis/tables/foodRequirementTable.php';
							}
							elseif($requirementType == 'medicine')
							{
								include_once '../analysis/tables/medRequirementTable.php';
							}
							else
							{
								include_once '../analysis/tables/shelterTemporaryTable.php';
							}
							?>
                                <div class="text-right">
                                    <a href="#">View Details <i class="fa fa-arrow-circle-right"></i></a>
