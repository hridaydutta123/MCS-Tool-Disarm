				...
				<div class="row">
                    <div class="col-lg-4">
                        <div class="panel panel-green">
							...
							<?php include_once '../analysis/bar/foodRequirementBar.php';?>
                    ...
                    <div class="col-lg-4">
                        <div class="panel panel-yellow">
                            ...
                            <div class="panel-body">
							<?php include_once '../analysis/bar/medRequirementBar.php';?>
                                <div class="text-right">
                                    <a href="#">View Details <i class="fa fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
					...
					<div class="col-lg-4">
                        <div class="panel panel-red">
                            ...
                            <div class="panel-body">
							<?php include_once '../analysis/pie/affectedDistPie.php';?>
                                <div class="text-right">
                                    <a href="#">View Details <i class="fa fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
				...
				<div class="row">
                    <div class="col-lg-4">
                        <div class="panel panel-green">
                            ...
                            <div class="panel-body">
							<?php include_once '../analysis/tables/foodRequirementTable.php';?>
                                <div class="text-right">
                                    <a href="#">View Details <i class="fa fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="panel panel-yellow">
                            ...
                            <div class="panel-body">
							<?php include_once '../analysis/tables/medRequirementTable.php';?>
                                <div class="text-right">
                                    <a href="#">View Details <i class="fa fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
					...
					<div class="col-lg-4">
                        <div class="panel panel-red">
                            ...
                            <div class="panel-body">
							<?php include_once '../analysis/tables/victimTable.php';?>
                                <div class="text-right">
                                    <a href="#">View Details <i class="fa fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
				...
				<div class="row">
                    <div class="col-lg-6">
                        <div class="panel panel-green">
                            ...
                            <div class="panel-body">
							<?php include_once '../analysis/pie/victimPie.php';?>
                                <div class="text-right">
                                    <a href="#">View Details <i class="fa fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="panel panel-yellow">
                            ...
                            <div class="panel-body">
							<?php include_once '../analysis/bar/victimBar.php';?>
                                <div class="text-right">
                                    <a href="#">View Details <i class="fa fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="panel panel-green">
                            ...
                            <div class="panel-body">
							<?php include_once '../analysis/pie/typePie.php';?>
                                <div class="text-right">
                                    <a href="#">View Details <i class="fa fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-8">
                        <div class="panel panel-yellow">
                            ...
                            <div class="panel-body">
							<?php include_once '../analysis/line/ttlLine.php';?>
                                <div class="text-right">
                                    <a href="#">View Details <i class="fa fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
